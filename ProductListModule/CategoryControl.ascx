<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CategoryControl.ascx.cs" Inherits="ProductListModule.CategoryControl" %>
...
<div>
    <asp:Repeater ID="Repeater1" runat="server" DataSourceID="SqlDataSource1">
        <ItemTemplate>
            ...
            <asp:LinkButton ID="sortButton" runat="server" OnClick="sortButton_Click" Text='<%# DataBinder.Eval(Container.DataItem, "cat_type") %>'></asp:LinkButton>&ensp;|&ensp;
        </ItemTemplate>
    </asp:Repeater>
</div>
...
<asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ProductListConnectionString %>" SelectCommand="SELECT [prod_id], [prod_name], [prod_price], [prod_img], [prod_cat] FROM [Product2] WHERE ([prod_cat] = @prod_cat)">
    <SelectParameters>
        <asp:QueryStringParameter Name="prod_cat" QueryStringField="catID" />
    </SelectParameters>
</asp:SqlDataSource>
