<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SearchControl.ascx.cs" Inherits="ProductListModule.SearchControl" %>
...
<div style="float:right; padding-top:2%;">
        ...
        &emsp;
        <asp:Button ID="btnCostumeShow" runat="server" Text="Search" OnClick="costumeShow_Click" />
    </div>
...
<asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ProductListConnectionString %>" SelectCommand="SELECT [prod_id], [prod_name], [prod_price], [prod_img], [prod_cat] FROM Product2 WHERE (prod_name LIKE @Keyword)">
    <SelectParameters>
