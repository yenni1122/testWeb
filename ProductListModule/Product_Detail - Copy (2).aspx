...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="margin-top: 5%;">
        ...
        <asp:DataList ID="DataList1" runat="server" DataKeyField="Prod_ID" DataSourceID="SqlDataSource1" Style="width: 80%; margin-top: -12%; margin-left: 20%;" OnItemDataBound="DataList1_ItemDataBound">
            <ItemTemplate>
        <asp:Label ID="Label5" runat="server" Text="TW99ING"></asp:Label>
                <td style="width: 160px; float: right; margin-top: 45%;">
                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl='<%#"~/image/" + DataBinder.Eval(Container.DataItem,"prod_img").ToString()%>' Width="150px" OnClick="Image_Click" />
                ...
                <td>
                    <br />
                    <br />
                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("prod_name") %>' />
                    <asp:Label ID="Label6" runat="server" Text="testing" /><br />
