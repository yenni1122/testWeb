...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <%-- <style>
    ...
    <div>
        ...
        <asp:DataList ID="DataList1" runat="server" DataKeyField="Prod_ID" DataSourceID="SqlDataSource1" Style="width: 80%; margin-left: 20%;" OnItemDataBound="DataList1_ItemDataBound">
            <ItemTemplate>
                <%--<td style="width: 160px; float: right;">
                ...
                <td>
                    ...
                    <asp:DataList ID="DataList3" runat="server" DataSourceID="SqlDataSource4">
                        <ItemTemplate>
                            <asp:Label ID="stock_count" runat="server" Text="Stock Available: "></asp:Label>
                            <asp:Label Text='<%# Eval("stock_count") %>' runat="server" ID="stock_countLabel" /><br />
                            <br />
                        </ItemTemplate>
                    </asp:DataList>
                    <asp:SqlDataSource runat="server" ID="SqlDataSource4" ConnectionString='<%$ ConnectionStrings:ProductListConnectionString %>' SelectCommand="SELECT [stock_count] FROM [Product2] WHERE ([prod_id] = @prod_id)">
                        <SelectParameters>
